...
export const serviciosMarketingES = {
  marketingPage: {
    ...
    heroPriceAnchor: 'Desde $697 setup + $97/mes',
    beforeAfter: {
    ...
    ctaSubtitle: 'Desde $697 tienes tu negocio en internet con una página que vende. También ofrecemos optimización de SEO local y Google Ads (cotización aparte).',
  },
}
...
export const serviciosMarketingEN = {
  marketingPage: {
    ...
    heroPriceAnchor: 'From $697 setup + $97/mo',
    beforeAfter: {
    ...
    ctaSubtitle: 'Starting at $697, get your business online with a page that sells. We also offer local SEO optimization and Google Ads (quoted separately).',
  },
}
