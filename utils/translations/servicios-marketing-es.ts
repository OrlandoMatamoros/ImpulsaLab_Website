// Auto-generated — ES-only slice of servicios-marketing.ts
// DO NOT edit directly; update servicios-marketing.ts and re-run scripts/split-translations.mjs
...
export default serviciosMarketingES
