// lib/tools-data.ts
// ÚNICA FUENTE DE VERDAD para todas las herramientas en el sitio
...
export const getToolsByCategory = (category: string): TechTool[] => {
  return techTools.filter(tool => tool.category === category);
};

// Obtener todas las categorías únicas
export const getCategories = (): string[] => {
  return Array.from(new Set(techTools.map(tool => tool.category)));
};

// Exportar techTools como 'tools' para compatibilidad
export const tools = techTools;
