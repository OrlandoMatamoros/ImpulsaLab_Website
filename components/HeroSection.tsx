          ...
          <div className="flex flex-col justify-center h-full">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/20">
              <div>
                ...
                <div className="text-sm md:text-base text-gray-300">{t.hero.metricaHoras}</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold text-white mb-1">3X</div>
                <div className="text-sm md:text-base text-gray-300">{t.hero.metricaProductividad}</div>
              </div>
              <div>
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className="flex items-center space-x-2 md:space-x-3 mb-3">
                          ...
                          <span className="font-bold text-sm md:text-base lg:text-lg text-white">{t.hero.arsenal}</span>
                        </div>
                        <p className="text-xs md:text-sm lg:text-base text-white/90 font-medium mb-2">
                          <span className="font-bold text-white">{t.hero.arsenalDesc}</span> {t.hero.arsenalDescFull}
                        </p>
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className="flex items-center space-x-2 md:space-x-3 mb-3">
                          ...
                          <span className="font-bold text-sm md:text-base lg:text-lg text-white">{t.hero.agentes}</span>
                        </div>
                        <p className="text-xs md:text-sm lg:text-base text-white/90 font-medium mb-2">
                          {t.hero.agentesDesc}
                        </p>
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className="flex items-center space-x-2 md:space-x-3 mb-3">
                          ...
                          <span className="font-bold text-sm md:text-base lg:text-lg text-white">{t.hero.noticias}</span>
                        </div>
                        <p className="text-xs md:text-sm lg:text-base text-white/90 font-medium mb-2">
                          {t.hero.noticiasDesc}
                        </p>
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className="flex items-center space-x-2 md:space-x-3 mb-3">
                          ...
                          <span className="font-bold text-sm md:text-base lg:text-lg text-white">{t.hero.promptDesigner}</span>
                        </div>
                        <p className="text-xs md:text-sm lg:text-base text-white/90 font-medium mb-2">
                          {t.hero.promptDesc}
                        </p>
