...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://goimpulsalab.com/herramientas' },
  openGraph: {
    title: 'Herramientas de IA Gratuitas para Negocios Latinos',
    ...
    url: 'https://goimpulsalab.com/herramientas',
    type: 'website',
    images: [{ url: '/opengraph-image.png?v=2', width: 1200, height: 630, alt: 'Impulsa Lab - Herramientas de IA' }],
  },
  twitter: {
