...
const faqSchemaItems = [
  {
    ...
    answer:
      'Impulsa Lab es una firma de consultoría de nueva generación con sede en Queens, Nueva York, especializada en democratizar la inteligencia de negocio para pequeñas y medianas empresas (PYMES). Utilizamos inteligencia artificial y análisis de datos para transformar los tres pilares fundamentales de tu negocio: Finanzas, Operaciones y Marketing.',
  },
  {
