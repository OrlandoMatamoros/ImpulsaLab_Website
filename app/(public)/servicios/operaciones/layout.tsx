...
export const metadata: Metadata = {
  ...
  description: 'Automatizacion de operaciones con agentes IA y n8n para PYMEs. Gestion de WhatsApp, facturacion automatica, plataformas inteligentes y flujos sin codigo. Desde $500 setup + $97/mes.',
  alternates: {
