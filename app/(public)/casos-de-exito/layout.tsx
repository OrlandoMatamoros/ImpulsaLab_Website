...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://goimpulsalab.com/casos-de-exito' },
  openGraph: {
    title: 'Casos de Exito - Resultados Reales de PYMEs con IA',
    ...
    url: 'https://goimpulsalab.com/casos-de-exito',
    type: 'website',
    images: [{ url: '/opengraph-image.png?v=2', width: 1200, height: 630, alt: 'Impulsa Lab - Casos de Exito' }],
  },
  twitter: {
